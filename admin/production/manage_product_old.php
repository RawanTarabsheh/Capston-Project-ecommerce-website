                              ...
                              <div class="field item form-group">
                                ...
                                <div class="field item form-group">
                                  ...
                                  <div class="field item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                      <textarea required="required" name='desc'></textarea></div>
                                    </div>
                                    <div class="field item form-group">
                      ...
                      $number=0;
                       ...
                       extract($row);
                        ...
                        <tr class="even pointer" style="line-height: 100px;">
                          ...
                          <td class="a-right a-right "><?php echo $date; ?> </td>
                           <?php 
                              ...
                              <div class="field item form-group">
                                ...
                                <div class="field item form-group">
                                  ...
                                  <div class="field item form-group">
                                    <label class="col-form-label col-md-3 col-sm-3  label-align">Description<span class="required">*</span></label>
                                    <div class="col-md-6 col-sm-6">
                                      <textarea required="required" name='desc1'></textarea></div>
                                    </div>
                                      <div class="field item form-group">
                                        <label class="col-form-label col-md-3 col-sm-3  label-align">Insert Image<span class="required">*</span></label>
                                        <div class="col-md-6 col-sm-6">
