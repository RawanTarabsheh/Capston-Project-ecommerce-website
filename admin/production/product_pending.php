...
$from_record_num = ($records_per_page * $page) - $records_per_page;
  ...
  // query products
      ...
      $stmt = $product->readAll_admin_pending($from_record_num, $records_per_page);
      $num  = $stmt->rowCount(); 
                       ...
                       extract($row);
                        ...
                        elseif($num_of_products==0)
                          ...
                          <td class=" last">
                            ...
                            <a href="product_pending.php?idd=<?php echo $product_id;?>"><span class="glyphicon glyphicon-trash" aria-hidden="true" style="color: #dc3545; font-size: 25px;"></span></a>
...
$page_url = "product_pending.php?";
  
// count all products in the database to calculate total pages
$total_rows = $product->countAll_padmin();
