...
if(isset($_GET['idd']))
{
  ...
  if($product->delete())
    ...
    header("Location:manage_product_v.php");
         ...
         if(isset($_POST['submit1']))
{
        ...
        $product->vendor_id      = $_SESSION['vendor_id1'];
                    ...
                    $.ajax(
                            {
                                ...
                                success: function(data)
                                {
                                  console.log(data);
                                    ...
                                    if(data1.product_offer!=0)
                                      $('select[name=feature1]').val(2);
                                      else
                          ...
                          ?>
                                <div class="field item form-group">
                                  ...
                                  <div class="col-md-6 col-sm-6">
                                    <label class="col-form-label col-md-6 col-sm-3  label-align">
                                      <?php echo $vendor->name; ?></label>
                                  ...
                                  <div class="field item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                     ...
                                     <div class="field item form-group">
                                      ...
                                      <div class="col-md-6 col-sm-6">
                                       <input type="file" id="file-input1" name="image" class="form-control-file">
                                     </div>
                                   </div>
                                       <div class="field item form-group">
...
$from_record_num = ($records_per_page * $page) - $records_per_page;
  ...
  // query products
    if(isset($_SESSION['vendor_id'])) {
      $product->vendor_id = $_SESSION['vendor_id'];
      $stmt               = $product->readAll_vid($from_record_num, $records_per_page);
       $num               = $stmt->rowCount();
     }
                       ...
                       extract($row);
                        ...
                        elseif($num_of_products==0)
                          ...
                          <td class=" last">
                            ...
                            <a href="manage_product_v.php?idd=<?php echo $product_id;?>"><span class="glyphicon glyphicon-trash" aria-hidden="true" style="color: #dc3545; font-size: 25px;"></span></a>
...
$page_url = "manage_product_v.php?";
  
// count all products in the database to calculate total pages
$total_rows = $product->countAll_vid();
