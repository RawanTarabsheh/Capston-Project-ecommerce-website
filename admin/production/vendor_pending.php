...
if($vendor_message->create())
  header("Location:vendor_pending.php");
                         ...
                         <div class="col-md-12 col-sm-12">
                          ...
                          ?>
                              ...
                              <div class="field item form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                  <input class="form-control" data-validate-length-range="6" data-validate-words="2" name="title" placeholder="Title" required="required" />
                                </div>
                              </div>
                                ...
                                <div class="field item form-group">
                                  ...
                                  <div class="field item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                      <textarea required="required" name='message' style="width: 333px;height: 250px;"></textarea></div>
                                    </div>
...
$from_record_num = ($records_per_page * $page) - $records_per_page;
  ...
  // query products
$stmt = $vendor->readAll_p($from_record_num, $records_per_page);
$num = $stmt->rowCount();
if($num>0){
                  ?>
                       ...
                       extract($row);
                        ...
                        <tr class="even pointer" style="line-height: 100px;">
                          ...
                          <td class=" last">
                            ...
                            <a href="vendor_pending.php?idd=<?php echo $vendor_id;?>"><span class="glyphicon glyphicon-trash" aria-hidden="true" style="color: #dc3545; font-size: 25px;"></span></a>
                          </td>
                        </tr>
                      <?php } ?>
                    </tbody>
...
$page_url = "vendor_pending.php?";
  
// count all products in the database to calculate total pages
$total_rows = $vendor->countAll_p();
